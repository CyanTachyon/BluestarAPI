...
public class FastDeque<E> implements Deque<E>, Cloneable, Serializable
{
    ...
    @Override
    public FastDeque<E> clone()
    {
        FastDeque<E> deque=new FastDeque<>();
        for (E e: this)
        {
            deque.addLast(e);
        }
    ...
    public FastDeque<E> deepClone() throws Throwable
    {
        FastDeque<E> deque=new FastDeque<>();
        for (E e: this)
        {
    ...
    public class QueIterator implements ListIterator<E>
    {
        ...
        public void remove()
        {
            FastDeque.this.removeItem(this);
        }

        public void set(E e)
        {
            FastDeque.this.set(this,e);
        }
